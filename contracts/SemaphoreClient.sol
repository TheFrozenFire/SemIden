...
import { Semaphore } from "semaphore/contracts/sol/Semaphore.sol";
...
contract SemaphoreClient {
    ...
    function insertIdentityAsClient(uint256 _leaf) internal {
    ...
    function setPermissioning(bool _newPermission) internal {
